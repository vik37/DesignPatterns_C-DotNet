...
using IteratorDP_UdemyDesignPatterns_ConsoleApp.Task;
using System;
using System.Linq;
...
namespace IteratorDP_UdemyDesignPatterns_ConsoleApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            #region Task
            var root = new Node<int>(2, new Node<int>(1), new Node<int>(3));

            Console.WriteLine(string.Join(",", root.PreOrder.Select(x => x)));
            #endregion
            Console.ReadLine();
        }
    }
